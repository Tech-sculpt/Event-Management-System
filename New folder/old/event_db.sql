...
(2, 'Maaz', '+923058769608', 'Maazzulfiqar992@gmail.com', 'ABCD', 1, 1, 0, 1, '0000-00-00 00:00:00');
...
INSERT INTO `venue` (`id`, `venue`, `address`, `description`, `rate`)
 VALUES
(1, 'Wedding Full Hall', 'Islamabad', 'Full Hall with Capacity of 100k ', 50000),
(2, 'Wedding Half Hall', 'Islamabad', 'Half Hall with capacity of 50 K guests ', 25000),
(3, 'Birthday', 'SIslamabad', 'All decoration included with capacity of 250 guests.', 15000),
(4, 'Parties', 'Islamabad', 'With Capacity of 1k .', 17000);
